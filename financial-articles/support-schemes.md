...
accordion:
  ...
  - title: Community Health Assist Scheme (CHAS)
    content: |
      ...
      [Apply online](https://chas.moh.gov.sg/Home/Welcome){:target="_blank"} (Need help applying online? Refer to [user guide](https://www-moh-gov-sg-admin.cwp.sg/docs/librariesprovider5/default-document-library/chas-eservice-user-guide.pdf){:target="_blank"})
